...
class C:
    ...
    # vehicle config
    RF = 3.3 * 33  # [m] distance from rear to vehicle front end of vehicle
    RB = 0.8 * 33 # [m] distance from rear to vehicle back end of vehicle
    W = 2.4 * 33  # [m] width of vehicle
    WD = 0.7 * W  # [m] distance between left-right wheels
    WB = 94  # [m] Wheel base
    TR = 0.44 * 33  # [m] Tyre radius
    TW = 0.7 * 33  # [m] Tyre width
    MAX_STEER = 0.30
...
class PATH:
    ...
    def calc_nearest_ind(self, node):
        ...
        # print("nearest index ", ind, "x ", self.cx[ind], "y ", self.cy[ind])
        self.index_old = ind
