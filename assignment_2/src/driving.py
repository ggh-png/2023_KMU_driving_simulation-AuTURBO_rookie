...
#=============================================
# angle을 제어하는 PID 제어기
# 입력으로 받은 reference_input과 feedback_input 값을 바탕으로 
# error을 계산하고 이를 PID 제어기에 넣어 조향각을 결정함.
#=============================================
def calculate_PID(reference_input, feedback_input):
    global error_sum, error_prev
    ...
    derivative_output = derivative_gain * (error - error_prev) # Compute the derivative output
    error_prev = error
